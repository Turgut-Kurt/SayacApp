...
const HouseBillDetail = props => {
    ...
    const valueText = {
        display: status === "Okunacak" ? "none" : status === "Tamamlandı" ? "none" : null
    };

    const read_icon = {
        display: status === "Ödenecek:" ? "none" : status === "Tamamlandı" ? "none" : null
    };

    const done_icon = {
        display: status === "Okunacak" ? "none" : status === "Ödenecek:" ? "none" : null
    };
